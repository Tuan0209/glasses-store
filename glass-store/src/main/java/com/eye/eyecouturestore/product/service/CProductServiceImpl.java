...
import com.eye.eyecouturestore.common.helper.PagingHelper;
import com.eye.eyecouturestore.product.dto.*;
import com.eye.eyecouturestore.product.mapper.CProductMapper;
import com.eye.eyecouturestore.product.model.*;
import com.eye.eyecouturestore.product.repository.*;
...
public class CProductServiceImpl implements CProductService {
    ...
    @Override
    public Object findPage(int pageIndex, int pageSize, String orderBy) {
